...
pub fn register(router: *Router, plugin_index: u16) !void {
    ...
    try router.register(.get, "/xrpc/com.atproto.sync.getRepo", syncGetRepo, plugin_index); // W2.3
    try router.register(.get, "/xrpc/com.atproto.sync.getRecord", syncGetRecord, plugin_index); // W2.3
    try router.register(.get, "/xrpc/com.atproto.sync.getBlocks", syncGetBlocks, plugin_index); // W2.3
    try router.register(.get, "/xrpc/com.atproto.sync.listRepos", syncListRepos, plugin_index); // W2.3
